...
{
	wxASSERT_MSG( m_pCurrentGroup != NULL, "current group is null" );
	wxASSERT_MSG( IsGroup(m_pCurrentGroup), "current group is not a group" );
...
{
	wxASSERT_MSG( m_xmlDoc != NULL, "xml document is null" );
